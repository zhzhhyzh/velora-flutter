...
class _CreateContestPageState extends State<CreateContestPage> {
  ...
  Future<void> _createContest() async {
    if (!_formKey.currentState!.validate() || _coverImageFile == null || _startDate == null || _endDate == null || _selectedCategory == null) {
    ...
    try {
      ...
      final storageRef = FirebaseStorage.instance.ref().child('contest_covers/${DateTime.now().millisecondsSinceEpoch}_${_coverImageFile!.path.split('/').last}');
                ...
                children: [
                  Expanded(
                    child: ElevatedButton(
                      ...
                      child: Text(_startDate == null ? 'Select Start Date' : DateFormat.yMd().format(_startDate!)),
                    ),
                  ),
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      child: Text(_endDate == null ? 'Select End Date' : DateFormat.yMd().format(_endDate!)),
                    ),
                  ),
                ],
              ),
